...
> = () => {
  ...
  useEffect(() => { 
    ...
    .catch(error => console.log("le match n'a pas pu etre recupere", error));
                  ...
                  <Text className="text-xs">
                    {matchperdate.matchStatus === "over"
                      ...
                      : <View className="flex flex-col items-center">
                        <Text className="flex flex-row items-center text-red-800">Direct</Text>
                        <View >
                        <Button onPress={handleRedirect} className="flex flex-row justify-start items-center">
                        <Ionicons name="play-circle" size={20} color="orange" />
                          <Text>Regarder</Text>
                        </Button>
                        </View>
                        </View>}
